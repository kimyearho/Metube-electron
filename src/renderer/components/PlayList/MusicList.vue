    ...
    <md-list id="list"
      ...
      <md-list-item :id="`item${index}`"
        ...
        <span class="md-list-item-text music-title cursor"
              @click="route(item, index)">{{ item.title }}</span>
        ...
        this.$http
          ...
          .then(res => {
            ...
            if (this.playType === 'play') {
              ...
              subChannelId = res.data.items[0].contentDetails.relatedPlaylists.uploads
        ...
        this.createLocalIndex(['type', 'playlistId']).then(() => {
          return this.$local
            ...
            .then(result => {
              ...
              this.channelPlaylistId = this.playType === 'channel' ? docs.channelPlaylistId : null
