  ...
  <div>
    ...
    <div class="wrapper">
      ...
      <el-row v-if="!isLogin">
        ...
        <el-col class="link">
          <md-button class="md-raised md-primary btn"
                     @click="signLink">{{ $t('COLLECTION.NO_LOGIN_BUTTON_LINK') }}</md-button>
        </el-col>
      </el-row>
        ...
        <el-col>
          <div class="menu1_tip">
            <div>
              ...
              <md-button class="md-raised b-primary c-add md-primary" @click="create">
      ...
      <el-row v-if="isLogin" class="el-scroll" :class="{ dynamicHeight: isSub }">
        ...
        <el-col class="noList"
                v-if="isLogin && myCollections.length === 0">{{ $t('COLLECTION.NO_PLAYLIST') }}</el-col>
        ...
        <el-col class="noList"
                v-if="isLogin && channelLists.length === 0">{{ $t('COLLECTION.NO_CHANNEL') }}</el-col>
