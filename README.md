...
<strong>So if you have a Metube user with a high YouTube API key, please me share it.</strong> There is nothing I can do. I would like to continue this project. If possible, minimize your searches and create your own collections to use as collections. The search API consumes a large amount of quota.
